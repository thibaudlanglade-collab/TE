/**
 * Trial dashboard landing.
 *
 * Shown on /#dashboard — the first thing a returning trial visitor sees,
 * and where new visitors land after clicking "Entrer dans mon espace" on
 * /#welcome. A warm, colorful welcome that mirrors the public landing
 * page's visual language.
 *
 * Ported from TE-main/frontend/src/pages/DashboardHome.tsx, adapted to
 * this repo's hash-based router and the feature set that actually exists
 * here (no /dashboard/devis, no /dashboard/clients — those were TE-main
 * only).
 */
import {
  Sparkles,
...
const QUICK_START: QuickStartCard[] = [
  ...
  },
  {
    ...
    description:
      "Posez une question en français à vos emails, vos documents, vos tableaux. Il lit là où il faut et répond avec vos données.",
    to: "/chat-assistant",
...
const RGPD_POINTS = [
  { icon: Lock, label: "Espace isolé, chiffré" },
  { icon: Server, label: "Hébergement en France" },
  { icon: Trash2, label: "Suppression à l'issue de l'essai" },
];
