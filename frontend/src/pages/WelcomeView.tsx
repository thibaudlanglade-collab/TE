/**
 * First-visit welcome page for a trial prospect.
 *
 * Shown after /app/{token} activation, before the visitor enters the
 * actual trial workspace. Explains the RGPD stance, sets expectations,
 * and gives a clear "Entrer dans mon espace" CTA that drops the user
 * into the Assistant.
 *
 * Ported from TE-main/frontend/src/pages/Welcome.tsx, adapted to this
 * repo's hash-based router (no react-router-dom).
 */
